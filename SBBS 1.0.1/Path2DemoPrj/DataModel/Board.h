...
@property(nonatomic, retain)NSString * name; //版面英文名
@property(nonatomic, retain)NSString * description; //版面中文名
...
@property(nonatomic, retain)NSArray * bm; //版主

//分区和收藏夹额外说明
@property(nonatomic, retain)NSString * sectionName; //分区中文名
@property(nonatomic, retain)NSString * sectionDescription; //显示[目录]或者[上级目录]
@property(nonatomic, retain)NSMutableArray * sectionBoards; //分区包含的版面
